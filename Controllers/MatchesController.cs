...
namespace SoccerWebApp.Controllers
{
    public class MatchesController : Controller
    {
        ...
        public MatchesController(SoccerWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var match = await _context.Match.SingleOrDefaultAsync(m => m.MatchID == id);
            if (match == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MatchID,MatchName")] Match match)
        {
            if (id != match.MatchID)
            {
                return NotFound();
